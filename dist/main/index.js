...
const version = "0.8.5";
const __dirname$1 = require$$0.dirname(url.fileURLToPath(typeof document === "undefined" ? require("url").pathToFileURL(__filename).href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("index.js", document.baseURI).href));
class Constants {
}
...
const createMainWindow = async (mainWindow2) => {
  ...
  const menu = require$$2.Menu.buildFromTemplate(menuTemplate);
  require$$2.Menu.setApplicationMenu(menu);
...
require$$2.app.on("ready", async () => {
  if (Constants.IS_DEV_ENV) {
    Promise.resolve().then(() => require("./index.dev-BOgLh-FZ.js"));
  }
